...
contract TestDEX2 is Test {
    ...
    address constant UNISWAPV2_ROUTER_ADDRESS =
        address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address constant UNISWAPV2_FACTORY_ADDRESS =
    ...
    uint128 constant MIN_AMOUNT_OUT = 1700 ether;
    ...
    function test_Sniper() public {
        /** CODE YOUR SOLUTION HERE */
        vm.startPrank(user);
        // TODO: Deploy your smart contract 'sniper`
        Sniper sniper = new Sniper(UNISWAPV2_FACTORY_ADDRESS);
        ...
        IWETH9(WETH_ADDRESS).deposit{value: ETH_TO_INVEST}();
        IWETH9(WETH_ADDRESS).transfer(address(sniper), ETH_TO_INVEST);
        ...
        console.log("Sniped Balance: %d", preciousBalance);
