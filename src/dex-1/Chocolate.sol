...
contract Chocolate is ERC20, Ownable {
    ...
    error Chocolate_ETHNOTACCEPTED();
    error Chocolate_INVALIDAMOUNT();

    constructor(
        uint256 _initialMint
    ) ERC20("Chocolate Token", "Choc") Ownable(msg.sender) {
    ...
    */
    function addChocolateLiquidity(
        ...
        IWETH(weth).approve(address(uniswapV2Router), _tokenAmount);
    ...
    */
    function swapChocolates(
        ...
        if (_tokenIn == address(this)) {
            ...
            if (msg.value != 0) revert Chocolate_ETHNOTACCEPTED();
            // pause undersand the path array;
            ...
            if (msg.value != _amountIn) revert Chocolate_INVALIDAMOUNT();
            // TODO: Convert ETH to WETH
            IWETH(weth).deposit{value: msg.value}();
            // TODO: Set the path array
